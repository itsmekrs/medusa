require 'content_dm/african_maps/collection'
require 'content_dm/african_maps/item'
  ...
  module AfricanMaps
    class Ingester
      ...
      def create_collection
        ...
        description = package_file_contents('collection_description.txt')
        ...
        replacing_object(pid) do
          ...
          collection = ContentDm::AfricanMaps::Collection.new(:pid => pid)
          collection.add_named_datastream('premis', :file => package_file('collection', 'premis.xml'))
          collection.save
          return collection
        end
      end
