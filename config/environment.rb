...
Rails::Initializer.run do |config|
  ...
  config.plugins = %W(engines acts_as_taggable_on_steroids resource_controller haml fluid-infusion hydra_repository stanford_salt white_list hydrangea_articles hydrangea_datasets hydrangea_books )
